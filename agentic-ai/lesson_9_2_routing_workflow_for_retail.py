...
def routing_agent(query, *args):
    ...
    * "pricing strategy" (e.g., asking for optimal pricing for a product)
    ...
    """
    classification_user_prompt = f"Analyze the query: {query}"
    task_type = call_openai(system_prompt, classification_user_prompt)
    ...
    if task_type == "product research":
        ...
        product_context_query = query # Or a refined version of query for product research
        customer_context_query = query # Or a refined version for customer analysis
